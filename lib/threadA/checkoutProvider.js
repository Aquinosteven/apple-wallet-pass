  ...
  return {
    ...
    async createCheckoutSession({ accountId, planCode, planLabel, amountCents, successUrl, cancelUrl: _cancelUrl }) {
      ...
      const requestBody = {
        ...
        quick_pay: {
          name: String(planLabel || normalizedPlanCode || "showfi_plan"),
          price_money: {
        ...
        checkout_options: {
          redirect_url: successUrl || "https://www.showfi.io/billing/success",
        },
        description: `ShowFi plan ${String(normalizedPlanCode || "showfi_plan")} for ${String(accountId || "unknown_account")}`,
      };
